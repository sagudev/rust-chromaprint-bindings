...
extern "C" {
    ...
    pub fn chromaprint_set_option(ctx: *mut ChromaprintContext, name: *const ::libc::c_char, value: ::libc::c_int) -> ::libc::c_int;
    pub fn chromaprint_start(ctx: *mut ChromaprintContext, sample_rate: ::libc::c_int, num_channels: ::libc::c_int) -> ::libc::c_int;
    pub fn chromaprint_feed(ctx: *mut ChromaprintContext, data: *const ::libc::c_void, size: ::libc::c_int) -> ::libc::c_int;
    pub fn chromaprint_finish(ctx: *mut ChromaprintContext) -> ::libc::c_int;
    pub fn chromaprint_get_fingerprint(ctx: *mut ChromaprintContext, fingerprint: *mut *mut ::libc::c_char) -> ::libc::c_int;
    pub fn chromaprint_get_raw_fingerprint(ctx: *mut ChromaprintContext, fingerprint: *mut *mut ::libc::c_void, size: *mut ::libc::c_int) -> ::libc::c_int;
